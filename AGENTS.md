...
- **Product Strategist** (`/sddp-prd`) creates or refines `docs/prd.md` as the canonical Product Document and registers it in `.github/sddp-config.md`
...
- `docs/prd.md` — canonical Product Requirements Document / Product Document when `/sddp-prd` is used
...
- **Product Document**: Registered in `sddp-config.md` under `## Product Document` → `**Path**:`. `docs/prd.md` created by `/sddp-prd` is the preferred source. Must pass sufficiency check (≥3/5 content categories).
