...
## Execution Rules
Never install new dependencies or global tools without explicit user permission. Parse failure logs cleanly, associate them with code locations where possible, and summarize raw output aggressively.
## Output Format
