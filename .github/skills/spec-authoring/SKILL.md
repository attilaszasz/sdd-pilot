...
- "Why this priority": only for P2+ where ranking is non-obvious.
...
## Size Budget
Keep `spec.md` ≤ **6KB**. If exceeded: consolidate overlapping requirements, tighten prose, defer low-impact detail to clarification.
