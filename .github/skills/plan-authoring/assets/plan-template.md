...
<!--
  data-model.md and contracts/ are conditional — generated only when the spec
  contains relevant signals (persistent data or API surface). When omitted,
  plan.md notes them as N/A.
-->
