...
1. `project-instructions.md` → load and execute `.github/sddp/workflows/init-project/WORKFLOW.md`
2. `PRODUCT_DOC` → load and execute `.github/sddp/workflows/product-document/WORKFLOW.md`
3. `TECH_CONTEXT_DOC` → load and execute `.github/sddp/workflows/system-design/WORKFLOW.md`
4. `DEPLOY_OPS_DOC` → load and execute `.github/sddp/workflows/deployment-operations/WORKFLOW.md` when `HAS_DOD = true` and `DOD_IMPACT = UPDATE`
5. `PROJECT_PLAN_DOC` → load and execute `.github/sddp/workflows/project-planning/WORKFLOW.md`
