...
- `.github/sddp/workflows/init-project/WORKFLOW.md` — shared config creation and preservation
...
**Execute `.github/sddp/workflows/product-document/WORKFLOW.md` inline** with enriched context:
...
**Execute `.github/sddp/workflows/system-design/WORKFLOW.md` inline** with enriched context:
...
**Execute `.github/sddp/workflows/deployment-operations/WORKFLOW.md` inline** with enriched context:
...
**Execute `.github/sddp/workflows/project-planning/WORKFLOW.md` inline** with enriched context:
...
**Execute `.github/sddp/workflows/init-project/WORKFLOW.md` inline** in `AMEND` mode:
